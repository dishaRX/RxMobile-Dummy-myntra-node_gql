...
exports.ChangeUserPasswordCase = void 0;
class ChangeUserPasswordCase {
    constructor(productDataRepository) {
        this.changePassword = (userId, oldPassword, newPassword) => __awaiter(this, void 0, void 0, function* () {
            return yield this.userDataRepository.changePassword(userId, oldPassword, newPassword);
        });
        this.userDataRepository = productDataRepository;
    }
}
exports.ChangeUserPasswordCase = ChangeUserPasswordCase;
